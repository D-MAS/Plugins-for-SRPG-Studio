...
(function() {
    ...
    Boss Bonus = 40
    */
	var ExperienceNoDamageMult = 1; // 0
	var ExperienceNormalHighBonus = 5; // 20
	var ExperienceNormalHighPenal = 5; // 20
	var ExperienceVictoryHighBonus = 10; // 20
	var ExperienceVictoryHighPenal = 10; // 20
